    ...
    var t = function() {
        function t(e) {
            ...
            var n = !0,
                ...
                o = void 0;
            try {
                for (var r, d = this.eventTypes[Symbol.iterator](); !(n = (r = d.next()).done); n = !0) {
                    var u = r.value;
                    this.event[u] = []
                }
            } catch (p) {
            ...
            this.trigger = function(e) {
                var t = !0,
                    ...
                    s = void 0;
                try {
                    for (var n, l = a.event[e][Symbol.iterator](); !(t = (n = l.next()).done); t = !0) {
                        var o = n.value;
                        o()
                    }
                } catch (r) {
        ...
        return _createClass(t, [{
            ...
            value: function() {
                ...
                if (this.multiple) {
                    for (l += '\n                <div class="aplayer-list" id="aplayer-list">\n                    <ol>', s = 0; s < this.option.music.length; s++) l += '\n                        <li>\n                            <span class="aplayer-list-cur" style="background: ' + this.option.theme + ';"></span>\n                            <span class="aplayer-list-index">' + (s + 1) + '</span>\n                            <span class="aplayer-list-title">' + this.option.music[s].title + '</span>\n                            <span class="aplayer-list-author">' +" - " + this.option.music[s].artist + '</span>\n                            <span class="aplayer-list-download"><a class="download" href='+this.option.music[s].url+' download><i class="fa fa-download" aria-hidden="true"></i></a>' + "</span>\n                        </li>";
                    l += "\n                    </ol>\n                </div>"
                }
                this.element.innerHTML = l, this.ptime = this.element.getElementsByClassName("aplayer-ptime")[0], this.element.getElementsByClassName("aplayer-info")[0].offsetWidth < 200 && this.element.getElementsByClassName("aplayer-time")[0].classList.add("aplayer-time-narrow"), this.element.getElementsByClassName("aplayer-bar-wrap")[0].style.marginRight = this.element.getElementsByClassName("aplayer-time")[0].offsetWidth + 5 + "px", this.option.narrow && this.element.classList.add("aplayer-narrow"), this.button = this.element.getElementsByClassName("aplayer-button")[0], this.button.addEventListener("click", function(e) {
                    ...
                    for (var e = i.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li"), t = function(t) {
                            e[t].addEventListener("click", function() {
                                ...
                                a !== i.playIndex && i.setMusic(a), i.play()
                            })
            ...
            value: function(e) {
                ...
                if (this.music = this.multiple ? this.option.music[a] : this.option.music, this.music.pic && (this.element.getElementsByClassName("aplayer-pic")[0].style.backgroundImage = "url(" + encodeURI(this.music.pic) + ")"), this.element.getElementsByClassName("aplayer-title")[0].innerHTML = this.music.title, this.element.getElementsByClassName("aplayer-author")[0].innerHTML = " - " + this.music.artist, this.multiple && (this.element.getElementsByClassName("aplayer-list-light")[0] && this.element.getElementsByClassName("aplayer-list-light")[0].classList.remove("aplayer-list-light"), this.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li")[a].classList.add("aplayer-list-light")), this.audio && (this.pause(), this.audio.currentTime = 0), this.multiple && !this.audios[a] || -1 === this.playIndex ? (this.audio = document.createElement("audio"), this.audio.src = this.music.url, this.audio.preload = this.isMobile ? "none" : "metadata", this.audio.addEventListener("durationchange", function() {
                        ...
                        t.playIndex < t.option.music.length - 1 ? t.setMusic(++t.playIndex) : t.loop ? t.setMusic(0) : t.loop || (t.ended = !0, t.pause(), t.trigger("ended"))
