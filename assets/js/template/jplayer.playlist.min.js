    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (media) {
            ...
            listItem +=
                ...
                "</a>" +
                (media.added ? '<a id="add_' + media.aid + '" class="add tips" href="#add?id=' + media.aid + '" title="ADD"><i class="icon-plus-squared"></i></a>' : "") +
                (media.delete ? '<a id="delete_' + media.aid + '" class="delete tips" href="#delete?id=' + media.aid + '" title="DELETE"><i class="icon-cancel"></i></a>' : "") +
